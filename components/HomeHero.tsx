export default function HomeHero() {
  return (
    <section className="relative flex min-h-[85dvh] items-center justify-center px-4 py-8 md:py-16 aurora-bg overflow-hidden">
      ...
      <div className="absolute inset-0 animate-aurora-drift" style={{ zIndex: 0 }}>
        ...
        >
          <defs>
            <linearGradient id="heroAurora1" x1="0%" y1="0%" x2="100%" y2="0%">
      ...
      <div className="absolute inset-0 animate-aurora-drift-reverse" style={{ zIndex: 0 }}>
        ...
        >
          <defs>
            <linearGradient id="heroAurora2" x1="0%" y1="0%" x2="100%" y2="0%">
              <stop offset="0%" stopColor="rgba(201, 168, 76, 0)" />
      ...
      <div className="absolute inset-0 animate-aurora-drift-slow" style={{ zIndex: 0 }}>
        ...
        >
          <defs>
            <linearGradient id="heroAurora3" x1="100%" y1="0%" x2="0%" y2="0%">
              <stop offset="0%" stopColor="rgba(201, 168, 76, 0)" />
      ...
      <div className="relative z-10 mx-auto max-w-4xl w-full text-center">
        <h1 className="font-serif text-3xl font-bold leading-[1.15] text-white sm:text-4xl md:text-5xl lg:text-6xl">
          ...
          <span className="text-gold">Lost Job.</span>
        </h1>

        <p className="mx-auto mt-4 max-w-2xl font-sans text-sm leading-relaxed text-muted md:mt-5 md:text-base">
          Contractors lose $500&ndash;$10,000 every time a call goes to voicemail.
          PrimeVoice answers every call, 24/7 &mdash; so you never lose another job.
        </p>

        <div className="mt-8 md:mt-10">
          <a
            href="#demo"
            className="inline-block rounded-xl bg-gold px-10 py-4 font-sans text-base font-semibold text-background transition-all duration-300 hover:bg-gold-light hover:scale-[1.02] active:scale-[0.98] animate-pulse-glow md:text-lg md:px-12 md:py-5"
          >
